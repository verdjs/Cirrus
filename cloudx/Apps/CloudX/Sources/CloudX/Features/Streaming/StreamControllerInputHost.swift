...
struct StreamControllerInputHost<Content: View>: UIViewControllerRepresentable {
    ...
    init(onOverlayToggle: (() -> Void)? = nil, onMenuPress: (() -> Void)? = nil, @ViewBuilder content: () -> Content) {
    ...
    func makeUIViewController(context: Context) -> StreamControllerInputViewController<Content> {
        StreamControllerInputViewController(rootView: content, onOverlayToggle: onOverlayToggle, onMenuPress: onMenuPress)
    }
...
final class StreamControllerInputViewController<Content: View>: GCEventViewController {
    ...
    init(rootView: Content, onOverlayToggle: (() -> Void)? = nil, onMenuPress: (() -> Void)? = nil) {
