...
public final class SettingsStore {
    ...
    public struct ControllerSettings: Sendable, Equatable {
        ...
        public var adaptiveTriggersMode: CloudXModels.ControllerSettings.AdaptiveTriggersMode
        ...
        public init(
            ...
            adaptiveTriggersMode: CloudXModels.ControllerSettings.AdaptiveTriggersMode = .gameplay
        ) {
            ...
            self.adaptiveTriggersMode = adaptiveTriggersMode
        }
    }
    ...
    private enum Key {
        ...
        static let adaptiveTriggersMode = "guide.controller_adaptive_triggers_mode"
    ...
    private nonisolated static func getDeviceModelIdentifier() -> String {
    ...
    public nonisolated static func isLegacyAppleTV() -> Bool {
        let identifier = getDeviceModelIdentifier()
        return identifier == "AppleTV5,3" || identifier == "AppleTV6,2"
    }

    private nonisolated static func registeredDefaults() -> [String: Any] {
        let legacy = isLegacyAppleTV()
        let defaultFloorBehavior = legacy ? UpscalingFloorBehavior.sampleFloor.rawValue : UpscalingFloorBehavior.metalFloor.rawValue
        ...
        Key.upscalingEnabled: false,
        Key.rendererMode: "auto",
        Key.sharpness: 0.0,
        Key.saturation: 1.0,
        Key.audioBoost: 3.0,
        Key.colorRange: "Auto",
        ...
        Key.adaptiveTriggersMode: CloudXModels.ControllerSettings.AdaptiveTriggersMode.gameplay.rawValue,
        ...
        Key.upscalingFloorBehavior: defaultFloorBehavior
        ]
    }
    ...
    public func buildControllerSettings() -> CloudXModels.ControllerSettings {
        ...
        settings.adaptiveTriggersMode = controller.adaptiveTriggersMode
        return settings
    }
    ...
    private func persist(_ value: ControllerSettings, oldValue: ControllerSettings) {
        ...
        defaults.set(value.adaptiveTriggersMode.rawValue, forKey: Key.adaptiveTriggersMode)
    }
    ...
    private nonisolated static func readController(from defaults: UserDefaults) -> ControllerSettings {
        ...
        let triggerInterpretationMode =
            ...
            ?? .auto
        let adaptiveTriggersModeRaw = string(
            defaults,
            Key.adaptiveTriggersMode,
            fallback: CloudXModels.ControllerSettings.AdaptiveTriggersMode.gameplay.rawValue
        )
        let adaptiveTriggersMode =
            CloudXModels.ControllerSettings.AdaptiveTriggersMode(rawValue: adaptiveTriggersModeRaw)
            ?? .gameplay
        ...
        return ControllerSettings(
            ...
            adaptiveTriggersMode: adaptiveTriggersMode
        )
    }
