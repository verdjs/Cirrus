...
public struct ControllerSettings: Sendable {
    ...
    /// Supported modes for PS5 DualSense adaptive triggers.
    public enum AdaptiveTriggersMode: String, Sendable, CaseIterable {
        case off = "off"
    ...
    /// Adaptive triggers mode for PS5 DualSense controllers.
    public var adaptiveTriggersMode: AdaptiveTriggersMode = .gameplay
    public init() {}
}
