...
public final class WebRTCClientImpl: NSObject, WebRTCBridge, @unchecked Sendable {
    ...
    nonisolated let callbackStateBox = WebRTCClientCallbackStateBox()
    nonisolated let stateBox = WebRTCClientStateBox()
    nonisolated let statsStateBox = WebRTCClientStatsStateBox()
    ...
    nonisolated let audioGateQueue = DispatchQueue(label: "com.cloudx.app.webrtc.audioGate")
    var audioGateHasRemoteTrack = false
    var audioGatePeerConnected = false
    var audioGateOpened = false
    nonisolated let dataChannelSendFailureQueue = DispatchQueue(label: "com.cloudx.app.webrtc.sendFailure")
