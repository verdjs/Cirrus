...
typealias FirstFrameCallback = @Sendable () -> Void
...
final class FrameProbeRenderer: NSObject, RTCVideoRenderer, @unchecked Sendable {
    ...
    private var onFirstFrameReceivedHandler: FirstFrameCallback?

    var onFirstFrameReceived: FirstFrameCallback? {
        get {
            stateLock.lock()
    ...
    func renderFrame(_ frame: RTCVideoFrame?) {
        ...
        var rtpDeltaMs = 0.0
        var firstFrameCallback: FirstFrameCallback?
