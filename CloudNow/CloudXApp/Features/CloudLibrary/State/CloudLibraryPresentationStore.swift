...
final class CloudLibraryPresentationStore {
    ...
    init(
        shellBuilder: CloudLibraryShellPresentationBuilder,
        browseBuilder: CloudLibraryBrowseRoutePresentationBuilder,
        utilityBuilder: CloudLibraryUtilityRoutePresentationBuilder
    ) {
