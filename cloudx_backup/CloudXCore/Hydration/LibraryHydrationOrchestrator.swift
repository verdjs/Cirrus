...
struct LibraryHydrationOrchestrator: LibraryHydrationOrchestrating {
    ...
    init(
        ...
        startupRestoreWorkflow: (any LibraryHydrationStartupRestoring)? = nil,
        liveRefreshWorkflow: (any LibraryHydrationLiveRefreshing)? = nil,
        liveCommitWorkflow: (any LibraryHydrationLiveCommitting)? = nil,
        postStreamDeltaWorkflow: (any LibraryHydrationPostStreamDeltaRunning)? = nil
    ) {
        self.planner = planner
        self.worker = worker
        self.persistenceStore = persistenceStore
        self.homeMerchandisingSIGLProvider = homeMerchandisingSIGLProvider
        self.startupRestoreWorkflow = startupRestoreWorkflow ?? LibraryHydrationStartupRestoreWorkflow()
        self.liveRefreshWorkflow = liveRefreshWorkflow ?? LibraryHydrationLiveRefreshWorkflow()
        self.liveCommitWorkflow = liveCommitWorkflow ?? LibraryHydrationLiveCommitWorkflow()
        self.postStreamDeltaWorkflow = postStreamDeltaWorkflow ?? LibraryHydrationPostStreamDeltaWorkflow()
    }
