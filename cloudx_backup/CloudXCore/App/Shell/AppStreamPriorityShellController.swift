...
final class AppStreamPriorityShellController {
    ...
    init(
        ...
        postStreamShellRecoveryWorkflow: PostStreamShellRecoveryWorkflow? = nil,
        ...
        self.postStreamShellRecoveryWorkflow = postStreamShellRecoveryWorkflow ?? PostStreamShellRecoveryWorkflow()
