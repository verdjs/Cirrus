...
final class StreamLaunchWorkflow {
    ...
    @MainActor
    init(
        homeLaunchWorkflow: StreamHomeLaunchWorkflow? = nil,
        cloudLaunchWorkflow: StreamCloudLaunchWorkflow? = nil
    ) {
        self.homeLaunchWorkflow = homeLaunchWorkflow ?? StreamHomeLaunchWorkflow()
        self.cloudLaunchWorkflow = cloudLaunchWorkflow ?? StreamCloudLaunchWorkflow()
    }
